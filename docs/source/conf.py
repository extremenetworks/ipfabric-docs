# -*- coding: utf-8 -*-
#
# IPfabric documentation build configuration file, created by
# sphinx-quickstart on Wed Aug  3 12:09:36 2016.
#
...
extlinks = {
    ...
    'github_mistral': ('https://github.com/StackStorm/mistral/blob/master/%s',
                       None),
    'github_contrib':
        ('https://github.com/StackStorm/st2contrib/blob/master/%s', None),
    'github_devenv': ('https://github.com/StackStorm/devenv/blob/master/%s',
                      None),
    'github_st2web': ('https://github.com/StackStorm/st2web/blob/master/%s',
                      None),
    'ops_latest':
        ('https://downloads.stackstorm.net/releases/st2/' + release + '/%s/',
         None)
}
...
# Note: '**/._*' exclues files my Sublime creates on NFS mount.
exclude_patterns = [
    '**/._*',
...
# documentation.
#
# TODO: 'base_url': 'http://docs.stackstorm.com/'
# html_theme_options = {}
...
#
# html_title = u'ipfabric-docs v1.0.0'
...
# TODO: Not sure of this is required ??
...
# man_pages = [
#     (master_doc, 'ipfabric-docs', u'ipfabric-docs Documentation',
#      [author], 1)
# ]
man_pages = [
